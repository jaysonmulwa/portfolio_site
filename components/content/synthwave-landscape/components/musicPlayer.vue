...
const attribution = 'Oh Baby by Seizo'
  ...
  <div :class="`music-player ${typing ? 'typing' : ''}`">
    ...
    >
      ...
      <audio
        ...
        autoplay
        loop
        src="https://github.com/jaysonmulwa/jaysonmulwa/blob/master/oh_baby.mp3?raw=true"
      >
        <a href="https://open.spotify.com/track/0RNdlFw9TaimQ6syL8rgCh?si=9d65810e9076452e"> Download audio </a>
      </audio>
    </div>
    <a href="https://open.spotify.com/track/0RNdlFw9TaimQ6syL8rgCh?si=9d65810e9076452e">{{ attributionDisplay }}</a>
  </div>
</template>
